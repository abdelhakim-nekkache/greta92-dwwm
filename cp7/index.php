...
<body class="container">
    <div class="jumbotron">
        ...
        <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#staticBackdrop">Inscription</a>
    </div>
    ...
    <form action="register.php" method="post">
      ...
      <div class="modal-body">
                <div>
                    ...
                    <input type="text" name="fname" id="fname" pattern="" required class="form-control" pattern="[A-Za-z\U00FF\-' ]">

                    <label for="mail">Courriel :</label>
                    <input type="email" name="mail" id="mail" pattern="" required class="form-control">
                </div>
